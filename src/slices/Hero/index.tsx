...
const Hero: FC<HeroProps> = ({ slice }) => (
  <Bounded
    ...
    className="relative grid w-screen flex-col items-center justify-self-center py-10 text-myblack-150 md:min-h-80 md:grid-cols-[26rem_1fr] lg:grid-cols-[2fr_1fr] 2xl:max-w-screen-xl 2xl:py-20 3xl:max-w-screen-2xl max-sm:gap-y-14 max-md:grid-rows-[1fr_1fr]"
  >
    {/* Content */}
