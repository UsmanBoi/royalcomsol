      ...
      {cardData.map((benefit, id) => (
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(to bottom right, rgba(250, 250, 250, 0.25) 12%, rgba(35, 107, 254, 0.07) 24%, rgba(35, 107, 254, 0.1) 40%, rgba(250, 250, 250, 0.5) 65%, rgba(35, 107, 254, 0.07) 78%, rgba(35, 107, 254, 0.1) 88%)",
          }}
          className="slide-in-up grid min-h-52 max-w-full grid-cols-[1fr_1fr] gap-4 rounded px-4 py-2 shadow-lg sm:p-4 2xl:max-w-xl 2xl:py-5 max-sm:max-w-sm"
        >
