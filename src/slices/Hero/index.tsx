...
const Hero: FC<HeroProps> = ({ slice }) => (
  <Bounded
    ...
    className="relative grid w-screen flex-col items-center justify-self-center py-10 text-myblack-200 sm:grid-cols-[1fr_1fr] 2xl:max-w-screen-xl 2xl:py-20 3xl:max-w-screen-2xl max-sm:gap-y-14"
  >
    {/* Content */}
    ...
    <div
      className={`flex h-auto w-fit flex-col justify-center gap-6 rounded-lg sm:gap-y-10 max-sm:w-80`}
    >
      <div className="flex flex-col gap-y-7">
        <h1 className="text-3xl lg:max-w-[36rem] lg:text-3xl lg:font-light xl:max-w-[45rem] xl:text-5xl 2xl:max-w-[52rem] 2xl:text-[80px]">
